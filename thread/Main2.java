...
public class Main2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        // Потоки совершенно хаотично ведут себя, тоесть потоки между собой не связаны никак
        // Они борятся за процессорная время, и кто первый захватит процессорная время, тот и
        // будет работать в этот момент, другой будет ждать или работать параллельно
